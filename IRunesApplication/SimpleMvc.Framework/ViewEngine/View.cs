namespace SimpleMvc.Framework.ViewEngine
{
    ...
    public class View : IRenderable
    {
        ...
        private string ReadFile()
        {
            ...
            if (parentDirectory.ToString().Contains("bin\\Debug"))
            {
                parentDirectory = Directory.GetParent(Directory.GetParent(Directory.GetParent(directory).ToString()).ToString());
            }

            var templateFullFilePath = $"{parentDirectory}\\{this.templateFullQualifiedName}{FileExtension}";
        ...
        private string GetErrorPath()
        {
            ...
            if (currentDirectory.ToString().Contains("bin\\Debug"))
            {
                parentDirectory = Directory.GetParent(Directory.GetParent(Directory.GetParent(Directory.GetParent(currentDirectory).ToString()).ToString()).ToString());
            }
