using System.Linq;
using Chuska.Models;
using Chuska.Models.ViewModels.Account;
...
namespace Chuska.Web.Controllers
{
    ...
    {
        private SignInManager<ChuskaUser> signIn;

        public AccountController(SignInManager<ChuskaUser> signIn)
        {
            this.signIn = signIn;
        }
